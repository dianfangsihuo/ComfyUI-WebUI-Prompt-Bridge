...
完整细节见 [CHANGELOG.md](CHANGELOG.md) 和 [v0.4.27 发布说明](docs/release-notes-v0.4.27.md)。更新后请重启 ComfyUI，并按 `Ctrl+F5` 强制刷新浏览器页面。
...
- **从图片读取 Prompt**：从 PNG/JPEG/WebP 的 ComfyUI metadata 读回 Bridge 正反 Prompt，并兼容 A1111 parameters 回退；应用前可选择候选和覆盖方向。
